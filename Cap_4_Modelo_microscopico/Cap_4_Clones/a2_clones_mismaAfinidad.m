%This code is desgined to simulate different populations of T cells with
%same pathogen affinity.
...
hold on
[hA4]=plot(time_vec,rec_vector_N_eff_clon1/max(rec_vector_N_eff),'c','LineWidth', 1);
...
set(gca,'YTickLabel',[]); 
set(gca,'XTickLabel',[]);
legend([hA1,hA4,hA3,hA2],'Células T efectoras clon 0','Células T efectoras clon 1','Células T de memoria','Patógeno');
